        ...
        <MDBContainer fluid className="box">
          {this.state.showConfirm
            ...
            <MDBContainer className="form-group">
              ...
              <input onClick={() => this.handleConfirmationResponse(false)} className="button float-left"
                type="submit" value="No"/>
              <input onClick={() => this.handleConfirmationResponse(true)} className="button float-right"
