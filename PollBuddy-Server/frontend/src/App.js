        ...
        <MDBContainer id="wrapper">
          ...
          */}
          ...
          <Routes>
            ...
            {/* --- Group Pages --- */}
            {/* My Groups Page */}
            <Route exact path="/groups" element={<PrivateComponent state element={<Groups updateTitle={updateTitle} />}/>}/>
            {/* Group Creation Page */}
            <Route exact path="/groups/new" element={<PrivateComponent state element={<GroupCreation updateTitle={updateTitle} />}/>}/>
            {/* Group's Page */}
            <Route exact path="/groups/:groupID" element={<PrivateComponent state element={<Group updateTitle={updateTitle} />}/>}/>
            {/* Group Edit Page */}
            ...
            {/* Reset Password Page */}
            <Route exact path="/login/reset" element={<PrivateComponent element={<ResetPassword updateTitle={updateTitle} />}/>}/>

            {/* --- Registration Pages --- */}
            {/* Register Main Page */}
            <Route exact path="/register" element={<PrivateComponent element={<RegisterDefault updateTitle={updateTitle} />}/>}/>
