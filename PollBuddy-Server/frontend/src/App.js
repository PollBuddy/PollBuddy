...
import InstructorLiveStats from "./pages/instructorLiveStats/instructorLiveStats";
        ...
        <MDBContainer id="wrapper">
          ...
          */}
          ...
          <Switch>
            ...
            <Route exact path="/instructorLiveStats">
              <InstructorLiveStats updateTitle={this.updateTitle} />
            </Route>
